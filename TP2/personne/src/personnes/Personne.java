...
public class Personne {
        ...
        if (getMere() != null){
            System.out.println(getMere().aPrenom + " "+ getMere().aNom);
            System.out.println("\tMère de "+this.aPrenom + " "+this.aNom);
            getMere().arbreGenealogique();
        }
        if (getPere() != null){
            System.out.println(getPere().aPrenom + " "+ getPere().aNom);
            System.out.println("\tPère de "+this.aPrenom + " "+this.aNom);
            getMere().arbreGenealogique();
        }
